...
@section('script')
    <script>
        ...
        function loadedAction() {
            ...
            var infowindow = displayInfowindow(map, marker, name);
            savedPlace.marker = marker;
            savedPlace.infowindow = infowindow;

            showSelectedPlace({getLat:function () {
                return lat;
            },getLng:function () {
                return lng;
            }}, name);
        ...
        function removeSavedPlace() {
            if (savedPlace != null) {
                savedPlace.infowindow.close();
                savedPlace.marker.setMap(null);
                savedPlace = null;
            }
        }
