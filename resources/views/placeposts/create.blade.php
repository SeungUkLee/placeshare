    ...
    <div class="container">
        <div class="map_wrap">
            ...
            <div id="menu_wrap" class="bg_white">
                <input class="list-toggle" id="list-toggle" type="checkbox"
                       hidden/>
...
@section('script')
    <script>
        ...
        function makeMarker(map, lat, lng) {
            ...
            marker.setMap(map)
            var boundRemoveMarker = removeMarker.bind(null, marker);
            daum.maps.event.addListener(marker, 'click', boundRemoveMarker);
